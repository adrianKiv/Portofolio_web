  ...
  const records = [
    {
      ...
      date: "Sep 2026",
      description:
        "Published a research paper sinta 4 titled 'Design and Development of a WebGIS Directory and Promotional Platform for Culinary MSMEs Using Content-Based Filtering' in Volume 13 Nomor 2.",
    ...
    },
    {
      ...
      date: "Oct 2025",
      description:
        "Demonstrated proficiency in Microsoft Word, validating essential skills in word processing and document management.",
    ...
    },
    {
      ...
      date: "Jun 2024",
      description:
        "Completed an intensive summer course focused on data analysis methodologies using the Python programming language.",
    ...
    },
    {
      ...
      date: "Dec 2023",
      description:
        "Earned certification demonstrating fundamental knowledge of cloud computing principles and database management using MySQL and SQL.",
      ...
      <div className="container mx-auto px-4 md:px-6 max-w-6xl">
        ...
        <div className="text-center mb-16 max-w-2xl mx-auto">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-lg">
            A showcase of my academic milestones, technical certifications, and
            ...
            >
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="flex items-center gap-3">
                  <div
                    className={`p-3 rounded-xl transition-colors ${item.type === "Achievement" ? "bg-yellow-50 text-yellow-600 dark:bg-yellow-900/30 dark:text-yellow-400 group-hover:bg-yellow-100 dark:group-hover:bg-yellow-900/50" : "bg-blue-50 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400 group-hover:bg-blue-100 dark:group-hover:bg-blue-900/50"}`}
                  >
                  ...
                  <span
                    className={`text-xs font-bold uppercase tracking-wider ${item.type === "Achievement" ? "text-yellow-600 dark:text-yellow-400" : "text-blue-600 dark:text-blue-400"}`}
                  >
                    {item.type}
                  </span>
                </div>

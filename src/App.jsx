...
function App() {
  return (
    <div className="bg-white dark:bg-gray-900 dark:text-white">
      <div className="fixed top-1/2 left-0 z-50 transform -translate-y-1/2 flex flex-col ml-1 space-y-4 pl-3 p-3 rounded-full bg-white shadow hover:bg-gray-300 dark:bg-gray-700 dark:hover:bg-sky-950">
        <a
          href="https://www.facebook.com/adrian.mulianto/"
          className="text-gray-500 hover:text-blue-600 dark:hover:text-blue-900"
          target="_blank"
        >
          <svg
            className="w-7 h-7"
        ...
        <a
          ...
          className="text-gray-500 hover:text-pink-500 dark:hover:text-pink-900"
          target="_blank"
        >
          <svg
            className="w-7 h-7"
        ...
        <a
          ...
          className="text-gray-500 hover:text-blue-700 dark:hover:text-blue-900"
          target="_blank"
        >
